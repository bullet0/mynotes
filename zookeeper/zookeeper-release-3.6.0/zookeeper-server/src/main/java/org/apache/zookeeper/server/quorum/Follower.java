...
public class Follower extends Learner {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    syncWithLeader(newEpochZxid); // 这里会卡住,直到leader发送 UPTODATE 消息
                    self.setZabState(QuorumPeer.ZabState.BROADCAST); // 接受到 UPTODATE 后才算可以对外服务
                    completedSync = true;
                } finally {
    ...
    protected void processPacket(QuorumPacket qp) throws Exception {
        ...
        case Leader.PING:
            ping(qp);
            break;
        case Leader.PROPOSAL: // leader让follower写事务的消息
            ...
            fzk.logRequest(hdr, txn, digest); // 写事务
            if (hdr != null) {
                /*
